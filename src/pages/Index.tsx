    ...
    <div className="min-h-screen bg-background grain relative">
      ...
      <section ref={heroRef} className="relative h-screen w-full overflow-hidden bg-gradient-noir">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center px-6 text-center" style={{ transform: `translateY(${scrollY * -0.25}px)`, opacity: Math.max(0, 1 - scrollY / 500) }}>
          ...
          <p className="font-serif italic text-xl md:text-2xl text-foreground/85 mt-10 animate-fade-up delay-200 max-w-2xl text-balance">Every imagination deserves to be written.</p>
          <div className="mt-16 animate-fade-up delay-300">
            <HeartButton glow onClick={() => navigate("/create")}>Begin your story</HeartButton>
          </div>
        </div>
      ...
      <section className="relative py-32 md:py-48 px-6 max-w-6xl mx-auto">
        <div className="text-center mb-24">
          ...
          <h2 className="font-display text-5xl md:text-7xl text-balance">Three simple steps.<br/><span className="italic font-normal text-muted-foreground">One story made for you.</span></h2>
        </div>
      ...
      <section className="relative py-32 md:py-48 px-6 text-center bg-gradient-noir border-t border-border">
        ...
        <div className="relative max-w-3xl mx-auto">
          <h2 className="font-display text-5xl md:text-7xl text-balance leading-[0.95]">Your next story is <span className="italic text-primary">waiting</span>.</h2>
          <p className="text-muted-foreground mt-8 max-w-lg mx-auto font-light">Bring your imagination to the page. It only takes a few seconds.</p>
          <div className="mt-12"><HeartButton glow onClick={() => navigate("/create")}>Create your story</HeartButton></div>
        </div>
      </section>
