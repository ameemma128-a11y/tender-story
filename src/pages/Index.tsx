...
const T: Record<string, Record<string, string>> = {
  en: {
    ...
    s1_title: "Pick a world", s1_desc: "Choose a genre that sparks you — from royal romance to fantasy academies. The mood is yours to set.",
    ...
    closing: "Your next story is", closing_bold: "waiting.", closing_sub: "Bring your imagination to the page. It only takes a few seconds.",
  },
  fr: {
    ...
    s1_title: "Choisir un univers", s1_desc: "Sélectionnez un genre — de la romance royale aux académies fantastiques. L'ambiance vous appartient.",
    ...
    s3_title: "Lire votre histoire", s3_desc: "Une scène immersive, écrite en quelques secondes. Sauvegardez-la, partagez-la.",
    closing: "Votre prochaine histoire vous", closing_bold: "attend.", closing_sub: "Donnez vie à votre imagination. Cela ne prend que quelques secondes.",
  },
  es: {
    ...
    s2_title: "Tus personajes", s2_desc: "Reales, ficticios o algo intermedio.",
    s3_title: "Lee tu historia", s3_desc: "Una escena inmersiva, escrita en segundos. Guárdala y compártela.",
    closing: "Tu próxima historia te", closing_bold: "espera.", closing_sub: "Dale vida a tu imaginación. Solo toma unos segundos.",
  },
  pt: {
    ...
    s1_title: "Escolha um mundo", s1_desc: "Escolha um gênero que te inspire.",
    s2_title: "Seus personagens", s2_desc: "Reais, fictícios ou algo no meio.",
    s3_title: "Leia sua história", s3_desc: "Uma cena imersiva, escrita em segundos.",
    closing: "Sua próxima história está", closing_bold: "esperando.", closing_sub: "Dê vida à sua imaginação.",
  },
  ko: {
    ...
    s3_title: "이야기 읽기", s3_desc: "몇 초 만에 당신을 위해 쓰인 몰입감 있는 장면.",
    closing: "다음 이야기가 당신을", closing_bold: "기다립니다.", closing_sub: "상상력을 글로 옮겨보세요.",
  },
  ja: {
    ...
    steps_sub: "あなたのための物語。",
    s1_title: "世界を選ぶ", s1_desc: "ジャンルを選んでください。",
    s2_title: "キャラクターを連れてくる", s2_desc: "実在、架空、どちらでも。",
    s3_title: "物語を読む", s3_desc: "数秒で書かれた没入感のある場面。",
    closing: "次の物語が", closing_bold: "待っています。", closing_sub: "想像力をページに込めましょう。",
  },
  ar: {
    ...
    s1_title: "اختر عالماً", s1_desc: "اختر نوعاً يلهمك.",
    s2_title: "أحضر شخصياتك", s2_desc: "حقيقيون أو خياليون.",
    s3_title: "اقرأ قصتك", s3_desc: "مشهد غامر، مكتوب لك في ثوانٍ.",
    closing: "قصتك التالية", closing_bold: "تنتظرك.", closing_sub: "أعطِ خيالك صوتاً.",
  },
  de: {
    ...
    steps_sub: "Eine Geschichte für dich.",
    s1_title: "Wähle eine Welt", s1_desc: "Wähle ein Genre — von royaler Romanze bis zur Fantasy-Akademie.",
    s2_title: "Bringe deine Charaktere", s2_desc: "Real, fiktiv oder irgendwo dazwischen.",
    s3_title: "Lies deine Geschichte", s3_desc: "Eine immersive Szene, in Sekunden für dich geschrieben.",
    closing: "Deine nächste Geschichte", closing_bold: "wartet.", closing_sub: "Bring deine Fantasie auf die Seite.",
  },
  it: {
    ...
    s2_title: "Porta i tuoi personaggi", s2_desc: "Reali, fittizi o qualcosa nel mezzo.",
    s3_title: "Leggi la tua storia", s3_desc: "Una scena immersiva, scritta in secondi.",
    closing: "La tua prossima storia ti", closing_bold: "aspetta.", closing_sub: "Porta la tua immaginazione sulla pagina.",
  },
};
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    const onStorage = () => {
      try { setLang(localStorage.getItem("tender_lang") || "en"); } catch {}
    };
